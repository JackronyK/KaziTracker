...
# ============================================================================
# 3. INTEGRATION - Add to your main.py
# ============================================================================

"""
In your main.py file, add the profile routes:
"""

from fastapi import FastAPI
from routes import profile  # ← Add this import

app = FastAPI()

# Include profile routes
app.include_router(profile.router)  # ← Add this line
